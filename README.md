...
* Method to move a copy of a file into each student's subdirectory after given ArrayList<Submssion>, String of current directory, and String name of file and returns void **moveFileIntoSubdir(ArrayList<Submission> labs, Path srcPath, String srcFile)**
